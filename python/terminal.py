...
class PanelSerial:
    def __init__(self, parent, title, align="left"):
        ...
        # Envia heartbeat apenas no painel da direita (HC-06 / Bluetooth)
        self._heartbeat_enabled = (align == "right")
    ...
    def _heartbeat_loop(self):
        # Byte NUL (0x00) como heartbeat: firmware pode filtrar e só usar pra "link ativo".
        while self._heartbeat_running and self.serial and self.serial.is_open:
            try:
